...
class TFT_eSprite : public TFT_eSPI {
 ...
 public:
  ...
  void     setBitmapColor(rgb_t fg, rgb_t bg);
  ...
  void     drawChar(int32_t x, int32_t y, uint16_t c, rgb_t color, rgb_t bg, uint8_t size),
           ...
           // Draw lines
           drawLine(int32_t x0, int32_t y0, int32_t x1, int32_t y1, rgb_t color),
  ...
  void     setRotation(uint8_t rotation, uint8_t REV) override;
  ...
  rgb_t    readPixel(int32_t x0, int32_t y0) override;
