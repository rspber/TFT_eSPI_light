...
TFT_eSPI::TFT_eSPI() : SnakeStamp()
{
  ...
  textfont  = 1;
  textsize  = 1;
  textcolor   = bitmap_fg = WHITE; // White
  textbgcolor = bitmap_bg = BLACK; // Black
  padX        = 0;                  // No padding
...
***************************************************************************************/
void TFT_eSPI::drawEllipse(int16_t x0, int16_t y0, int32_t rx, int32_t ry, rgb_t color)
{
  if (rx<2) return;
  if (ry<2) return;
  int32_t x, y;
...
***************************************************************************************/
void TFT_eSPI::fillEllipse(int16_t x0, int16_t y0, int32_t rx, int32_t ry, rgb_t color)
{
  if (rx<2) return;
  if (ry<2) return;
  int32_t x, y;
...
void TFT_eSPI::drawRoundRect(int32_t x, int32_t y, int32_t w, int32_t h, int32_t r, rgb_t color)
{
  //begin_tft_write();          // Sprite class can use this function, avoiding begin_tft_write()
  inTransaction = true;
...
***************************************************************************************/
void TFT_eSPI::pushColor(rgb_t color)
{
  begin_tft_write();
...
***************************************************************************************/
void TFT_eSPI::pushColor(rgb_t color, int32_t len)
{
  begin_tft_write();
...
***************************************************************************************/
void TFT_eSPI::writeColor(rgb_t color, int32_t len)
{
  pushBlock(color, len);
}
...
void TFT_eSPI::pushColors(uint8_t *data, int32_t len)
{
  begin_tft_write();
...
***************************************************************************************/
void TFT_eSPI::pushColors(uint16_t *data, int32_t len, bool swap)
{
  begin_tft_write();
...
***************************************************************************************/
void TFT_eSPI::drawSmoothArc(int32_t x, int32_t y, int32_t r, int32_t ir, int32_t startAngle, int32_t endAngle, rgb_t fg_color, rgb_t bg_color, bool roundEnds)
// Centre at x,y
