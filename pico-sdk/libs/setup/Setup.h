...
// all color comes from RGB macro, even 0 is not a BLACK
//#define OVERLAID      // enable overlaid in writeColor

//#define TFT_PIO_16BIT  // TODO
//#define TFT_PIO_8BIT  // TODO
//#define TFT_PIO_SPI_WRITE
//#define TFT_PIO_SPI_READ   not works yet
//#else SPI
...
#if defined(TFT_PIO_16BIT)
// TODO
#elif defined(TFT_PIO_8BIT)
// TODO
#elif defined(TFT_PIO_SPI_WRITE)

  #define TFT_WRITE_SPEED    625 * 100 * 1000          // 62,5 MHz

#else // SPI

  #define TFT_WRITE_SPEED    70 * 1000 * 1000          // 60 MHz
